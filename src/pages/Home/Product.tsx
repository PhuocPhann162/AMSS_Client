    ...
    <div className='grid h-screen grid-rows-[auto_1fr_auto]'>
      ...
      <main>
        <section className=' mx-auto grid grid-cols-2 gap-14 items-center'>
          <img className='w-96 mx-40' src='img-1.jpg' alt='person with dog overlooking mountain with sunset' />
          <div>
            <h2 className='text-2xl font-semibold leading-6 mb-12'>About WorldWide.</h2>
