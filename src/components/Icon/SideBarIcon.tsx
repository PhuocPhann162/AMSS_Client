export const ExpandSidebarIcon = (open: boolean) => {
  return (
    <svg
...
export const ClimateIcon = () => {
  return (
    <svg
      ...
      strokeLinecap='round'
      strokeLinejoin='round'
      className='feather feather-cloud-snow h-5 w-5'
    >
  ...
  return (
    ...
    >
      ...
      <g>
        <path
          className='st0'
          d='M54.425,266.279c22.795,0,42.291-14.024,50.394-33.914c8.103,19.89,27.598,33.914,50.394,33.914
        ...
        <path
          className='st0'
          d='M438.283,44.886c-9.158-18.945-28.346-30.976-49.386-30.976H123.102c-21.039,0-40.228,12.032-49.386,30.976
              L0,197.343h512L438.283,44.886z'
        />
        <path
          className='st0'
          d='M441.11,429.665c-0.008,8.929-3.567,16.85-9.417,22.724c-5.866,5.85-13.788,9.41-22.717,9.418H268.094V302.563
